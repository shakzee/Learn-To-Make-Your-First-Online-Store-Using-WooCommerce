...
3 - Images used from Pexels.
	Pexels provides images under CC0 license (https://www.pexels.com/photo-license/)

	Bundled header image, Copyright kinkate  
	License: CC0 1.0 Universal (CC0 1.0)
	Source: https://www.pexels.com/photo/black-corded-headset-205926/

	Bundled header image, Copyright David Bartus
	License: CC0 1.0 Universal (CC0 1.0)
	Source: https://www.pexels.com/photo/blur-box-business-checkered-shirt-297933/

	Bundled header image, Copyright 27707
	License: CC0 1.0 Universal (CC0 1.0)
	Source: https://www.pexels.com/photo/man-using-laptop-on-table-against-white-background-257897/

	Bundled header image, Copyright Rakin 
	License: CC0 1.0 Universal (CC0 1.0)
	Source: https://www.pexels.com/photo/footwear-leather-shoes-wear-267320/

	Bundled header image, Copyright Uva Rova
	License: CC0 1.0 Universal (CC0 1.0)
...
Version 0.3.0
	i)   Added Typography.
	ii)  Updated Woocommerce.
	iii) Added post formats tag.
	iv)  Fixed theme bugs.
	v)   Done responsive media styling.

Version 0.3.1
	i)   Update: Bootstrap version 4.0.0
	ii)  Update: language folder pot file.
	iii) Update: rtl file.
	iv)  Added:  Post format, custom header, featured image header tags.
	v)	 Fixed:  Theme Minor issues.

Version 0.3.2
	i)   Update: Ecommerce in theme.
	ii)  Update: language folder pot file.
	iii) Fixed:  Theme Error.

Version 0.3.3
	i)   Changed the woocommerce checkout page css.
